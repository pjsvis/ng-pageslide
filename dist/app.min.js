...
// }
// angular.module('app').factory('HttpHelper', function(){
// let fac: IHttpHelper = {
// };
// return fac;
// }); 
...
angular.module("app").component('psUserForm', {
    ...
    controller: function (DataService) {
        ...
        function add(suite) {
            var testSuites = angular.copy(vm.testSuites);
            testSuites.push(suite);
            vm.testSuites = testSuites;
            var index = vm.availableTestSuites.indexOf(suite);
            vm.availableTestSuites.splice(index, 1);
        }
        function remove(suite) {
            var availableTestSuites = angular.copy(vm.availableTestSuites);
            availableTestSuites.push(suite);
            vm.availableTestSuites = availableTestSuites;
            var index = vm.testSuites.indexOf(suite);
